        ...
        >
          <div className="text-center max-w-2xl mx-auto">
            ...
            <p className="text-slate text-sm sm:text-base mt-2.5">
              Everything you need to pilot your marketing campaigns with
              absolute confidence.
            </p>
          </div>
          ...
          <div className="mt-14 grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="rounded-2xl border border-line bg-white p-6 shadow-sm flex flex-col justify-between hover:shadow-md transition min-h-[220px]">
              <div className="space-y-2">
                <div className="flex items-center gap-2">
                  ...
                  <h3 className="font-display font-bold text-sm text-ink">
                    Custom Branding & Aliases
                  </h3>
                </div>
                <p className="text-xs text-slate leading-relaxed max-w-md">
                  Create highly recognizable short URLs. Replace random
                  character strings with clean, custom branding keywords.
                </p>
              </div>
              ...
              <div className="mt-4 rounded-xl border border-line bg-mist/40 p-4 space-y-2 select-none">
                ...
                <div className="flex items-center justify-between gap-4 text-xs font-semibold text-ink">
                  <span className="truncate max-w-[200px] text-slate font-medium">
                    github.com/apurva-sri/url_shortener
                  </span>
                  <span className="text-accent bg-accent-50 border border-accent/20 px-2 py-0.5 rounded font-mono">
                    /lp-repo
                  </span>
                </div>
              </div>
            ...
            <div className="rounded-2xl border border-line bg-white p-6 shadow-sm flex flex-col justify-between hover:shadow-md transition min-h-[220px]">
              <div className="space-y-2">
                ...
                <p className="text-xs text-slate leading-relaxed max-w-md">
                  Lock your campaigns. Protect files and restricted redirect
                  endpoints behind dynamic password verification forms.
                </p>
              </div>
            ...
            <div className="rounded-2xl border border-line bg-white p-6 shadow-sm flex flex-col justify-between hover:shadow-md transition min-h-[220px]">
              <div className="space-y-2">
                ...
                <p className="text-xs text-slate leading-relaxed max-w-md">
                  Track visitor count, browsers, and location metrics. Know who
                  clicked and when with detailed access logs.
                </p>
              </div>
            ...
            <div className="rounded-2xl border border-line bg-white p-6 shadow-sm flex flex-col justify-between hover:shadow-md transition min-h-[220px]">
              <div className="space-y-2">
                ...
                <p className="text-xs text-slate leading-relaxed max-w-md">
                  Generate high-quality vector QR codes. Add custom colors, dot
                  presets, and display branding center logos.
                </p>
              </div>
              ...
              <div className="mt-4 rounded-xl border border-line bg-mist/30 p-3 flex items-center justify-between select-none">
                <div className="space-y-1">
                  <span className="text-[9px] font-bold text-slate block">
                    COLOR PALETTE
                  </span>
                ...
                <div className="h-10 w-10 bg-white border border-line rounded flex items-center justify-center relative shadow-xxs">
                  <div className="grid grid-cols-4 gap-0.5 p-0.5 w-full h-full opacity-60">
                    {[...Array(16)].map((_, i) => (
                      <span
                        key={i}
                        className={`rounded-sm ${(i * 3) % 2 === 0 ? "bg-ink" : "bg-transparent"}`}
                      />
                    ))}
                  </div>
                  <img
                    src="/logo/linkpilot-mark.svg"
                    className="absolute w-2.5 h-2.5 bg-white p-0.5 rounded-xs"
                  />
                </div>
              </div>
            </div>
            ...
            <div className="rounded-2xl border border-line bg-white p-6 shadow-sm flex flex-col justify-between hover:shadow-md transition min-h-[220px]">
              <div className="space-y-2">
                ...
                <p className="text-xs text-slate leading-relaxed max-w-md">
                  Deactivate links automatically. Set custom expiration dates to
                  run temporary campaigns, preventing users from landing on
                  outdated content.
                </p>
              </div>
              ...
              <div className="mt-4 rounded-xl border border-line bg-mist/40 p-4 space-y-2 select-none text-[10px]">
                <div className="flex items-center justify-between font-bold text-slate">
                  ...
                  <span className="text-amber-600 bg-amber-50 border border-amber-100 px-2 py-0.5 rounded font-semibold animate-pulse">
                    Expires Soon
                  </span>
                </div>
                <div className="flex items-center justify-between text-xs font-semibold text-ink">
                  <span>flash-sale-2026</span>
                  <span className="text-slate font-mono font-medium">
                    18 hours left
                  </span>
                </div>
              </div>
            ...
            <div className="rounded-2xl border border-line bg-white p-6 shadow-sm flex flex-col justify-between hover:shadow-md transition min-h-[220px]">
              <div className="space-y-2">
                ...
                <p className="text-xs text-slate leading-relaxed max-w-md">
                  Route short codes through your own custom domains. Point your
                  CNAME record to LinkPilot to unify branding.
                </p>
              </div>
        ...
        >
          <div className="text-center max-w-2xl mx-auto">
            ...
            <div className="mt-6 flex items-center justify-center gap-3">
              <span
                className={`text-xs font-semibold ${billingPeriod === "monthly" ? "text-ink" : "text-slate"}`}
              >
                Monthly
              </span>
              <button
              ...
              <span
                className={`text-xs font-semibold flex items-center gap-1.5 ${billingPeriod === "annual" ? "text-ink" : "text-slate"}`}
              >
                Annually{" "}
          ...
          <div className="max-w-5xl mx-auto">
            <div className="text-center max-w-2xl mx-auto mb-14">
              ...
              <p className="text-slate text-sm sm:text-base mt-3 leading-relaxed">
                LinkPilot started as a side project to solve a simple
                frustration ugly, untrackable links cluttering marketing
                campaigns. Today it&apos;s a full-stack link intelligence
                platform.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="rounded-2xl border border-line bg-white p-6 space-y-3">
                ...
                <p className="text-xs text-slate leading-relaxed">
                  Make link management effortless for creators, marketers, and
                  developers with deep analytics, branded QR codes, and
              ...
              <div className="rounded-2xl border border-line bg-white p-6 space-y-3">
                ...
                <p className="text-xs text-slate leading-relaxed">
                  LinkPilot is built on a modern stack: React, Node.js,
                  PostgreSQL, Redis, and Cloudinary. Every feature ships with
                  observability, rate-limiting, and security best practices
              ...
              <div className="rounded-2xl border border-line bg-white p-6 space-y-3">
                ...
                <p className="text-xs text-slate leading-relaxed">
                  We&apos;re actively building team workspaces, Zapier
                  integrations, bulk link imports, and a public API. If
                  you&apos;re a developer, the API is already live build
            ...
            <div className="mt-10 rounded-2xl border border-line bg-mist/40 p-8 flex flex-col sm:flex-row items-center justify-between gap-6">
              <div>
                ...
                <p className="text-xs text-slate mt-1 max-w-sm">
                  LinkPilot is a passion project. If you find a bug, have a
                  feature idea, or just want to say hi reach out. Every piece of
            ...
            <div className="mt-12 divide-y divide-line">
              {LANDING_FAQS.map((faq, i) => (
                <div key={i} className="py-4 font-display">
                  ...
                  {activeFaq === i && (
                    <p className="mt-2.5 text-sm text-slate leading-relaxed">
                      {faq.a}
                    </p>
                  )}
                </div>
...
function PricingCard({
  ...
  return (
    ...
    >
      ...
      <p className="mt-2 text-xs text-slate leading-relaxed min-h-[40px]">
        {description}
      </p>
